...
```{=html}
<iframe class="slide-deck" src="/talks/5-teaching-materials/quarto-teaching-materials.html" height="420" width="747" style="border: 1px solid #2e3846;"></iframe>
```
## Speaker

![](maria-tackett-photo.png){fig-alt="A photo of Maria Tackett" fig-align="right" width="300"}
